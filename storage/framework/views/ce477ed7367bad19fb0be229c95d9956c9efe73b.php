                ...
                <tr>
                    ...
                    <td class="p-4">
                        <form action="<?php echo e(route('producto.destroy',$item)); ?>" method="post">
                            ...
                            <a href="<?php echo e(route('producto.edit',$item)); ?>" class="p-2 left-padding:3 bg-yellow-300 font-bold rounded hover:bg-yellow-800">Editar</a>
...
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php /**PATH C:\srv\laravel\supermercado\resources\views/producto/index.blade.php ENDPATH**/ ?>